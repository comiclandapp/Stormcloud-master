...
//            //...
//            self.formatter.timeZone = chicagoTimezone
//        }
	}
	...
	*/
	open func enableiCloudShouldMoveDocuments(_ move: Bool,
                                              completion: ((_ error : StormcloudError?) -> Void)? ) {
	...
	- parameter completion: A completion handler to run when the attempt to copy documents has finished.
	*/
	open func disableiCloudShouldMoveiCloudDocumentsToLocal(_ move: Bool,
                                                            completion: ((_ moveSuccessful : Bool) -> Void)? ) {
		let currentItems = self.internalList
		deleteAllItems()
	...
	func moveItemsToiCloud(_ items: [StormcloudDocumentType : [StormcloudMetadata]],
                           completion: ((_ error : StormcloudError?) -> Void)? ) {
	...
	func moveItemsFromiCloud(_ items: [StormcloudDocumentType :  [StormcloudMetadata]],
...
extension Stormcloud {
	...
	public func addDocument(withData objects: Any,
                            for documentType: StormcloudDocumentType,
                            completion: @escaping StormcloudDocumentClosure ) {
...
extension Stormcloud {
	...
	*/
	public func restoreBackup(from metadata: StormcloudMetadata,
                              completion: @escaping (_ error: StormcloudError?, _ restoredObjects : Any? ) -> () ) {
	...
	public func deleteItems(_ type: StormcloudDocumentType,
                            overLimit limit: Int,
	...
	*/
	public func deleteItem(_ metadataItem: StormcloudMetadata,
                           completion: @escaping (_ index : Int?, _ error : StormcloudError?) -> () ) {
